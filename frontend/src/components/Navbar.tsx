...
//   return (
//     <nav className="{${theme === 'light' ? 'navbar-light' : 'navbar-dark'}} bg-gradient-to-r from-[#6a11cb] via-[#ab67df] to-[#2575fc] fixed w-full z-20 top-0 start-0">
//       <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
//         <Link to="/app" className="flex items-center justify-between space-x-3 rtl:space-x-reverse" onClick={closeMenu}>
//           <div className="flex items-center space-x-3 rtl:space-x-reverse">
//             <img src={logo} className="h-8" alt="Styleshare Logo" />
...
const Navbar: React.FC<NavbarProps> = ({ theme, toggleTheme }) => {
  ...
  return (
    <nav className={`${theme === 'light' ? 'navbar-light' : 'navbar-dark'} fixed w-full z-20 top-0 start-0`}>
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <Link to="/app" className="flex items-center justify-between space-x-4 rtl:space-x-reverse" onClick={closeMenu}>
          <div className="flex items-center space-x-3 rtl:space-x-reverse">
            <img src={logo} className="h-8" alt="Styleshare Logo" />
            <span className={`self-center text-2xl font-bold text-white font-mono`}>
              {t("navbar.logo")}
          ...
          <div>
            <LanguageDropdown theme={theme === 'light' ? 'light' : 'dark'}  />
          </div>
